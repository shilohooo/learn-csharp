...
public class ConfigTestContext : DbContext
{
    ...
    public ConfigTestContext()
    {
    }

    public ConfigTestContext(IConfiguration configuration)
    {
    ...
    {
        var connectionString = _configuration.GetConnectionString("ConfigTestConnectionString");
