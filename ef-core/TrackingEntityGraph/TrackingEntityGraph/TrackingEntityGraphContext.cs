...
/// 数据上下文
/// </summary>
public class TrackingEntityGraphContext : DbContext
{
    ...
    {
        const string connStr = @"Server=(localdb)\MSSQLLocalDB;Database=TrackingEntityGraph;Trusted_Connection=True;";
